...
//hàm này CHỈ cập nhật lại mảng danhSachVe. maLichChieu và taiKhoanNguoiDung sẽ xử lý dựa vào state isLoggedIn.
// Hàm này kích hoạt mỗi khi user click chọn ghế (onChange)
...
export { actDanhSachVe, actRefreshBuyTicket, filterDanhSachVe, actBuyTicket };

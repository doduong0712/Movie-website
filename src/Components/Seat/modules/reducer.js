...
const buyTicketReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case CHOSING_TICKETS:
      /**Cần filter lại 2 TH:
       1. TH chỉ chọn thêm ghế: Nếu user chọn thêm 1 ghế thì action.danhSachVe sẽ có 2 phần tử 
       
       được add thêm vào danhSachVe (đang có sẵn 1 ghế) -> sẽ lặp ghế cũ (xảy ra double ghế đầu tiên, tức mảng sẽ có 3 phần tử trong khi user chỉ chọn 2 ghế), tương tự khi chọn 3 ghế thì (danhSachVe) sẽ có 6 pt, 4->10.
